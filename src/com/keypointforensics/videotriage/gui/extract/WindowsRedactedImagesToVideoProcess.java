...
public class WindowsRedactedImagesToVideoProcess {
	...
	public String apply(String redactedImageFileFormat, String outputVideoFilename, final Integer targetFramesPerSecond,
			final ProgressBundle progressBundle) throws InterruptedException {
		...
		final String command = "\"" + FileUtilsLegacy.BINARIES_DIRECTORY
				...
				+ (targetFramesPerSecond != null ? " -framerate " + String.valueOf(targetFramesPerSecond) : "") + " -i "
